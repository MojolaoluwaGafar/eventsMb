  ...
  return (
    <AppLayout>
     <div className="px-8 lg:px-20">
        ...
        exit={{ opacity: 0 }}
        className="space-y-12 py-8 container mx-auto"
      >
        ...
        <section className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="lg:w-1/2 space-y-4">
            <h2 className="text-3xl sm:text-center  md:text-start font-semibold text-purple-600">
              Our Mission
            </h2>
            <p className="text-gray-700 sm:text-center md:text-start leading-relaxed text-[12px] lg:text-lg">
        ...
        <section className="text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-evenly mt-6 w-full">
            <div className="">
              <img
        ...
        <section className="text-center space-y-3">
          ...
          <img
            ...
            alt="Celebration"
            className="w-full mx-auto rounded-lg shadow-lg mt-4"
          />
        </section>
      </motion.div>
     </div>
