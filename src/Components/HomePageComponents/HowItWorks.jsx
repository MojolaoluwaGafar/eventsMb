  ...
  return (
    <div className="flex-row items-center py-5 px-8 lg:px-20">
     <div className="container mx-auto">
       <h1 className="text-[25px] lg:text-[30px] text-center font-semibold">How it works</h1>
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 py-5">
